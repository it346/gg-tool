package io.github.it346.secure.utils;

import io.github.it346.launch.constant.TokenConstant;
import io.github.it346.secure.TokenInfo;
...
import io.github.it346.secure.provider.IClientDetails;
import io.github.it346.secure.provider.IClientDetailsService;
import io.github.it346.tool.constant.RoleConstant;
...
public class SecureUtil {
	...
	private static TokenProperties TOKEN_PROPERTIES;
	...
	private static TokenProperties getTokenProperties() {
		if (TOKEN_PROPERTIES == null) {
			TOKEN_PROPERTIES = SpringUtil.getBean(TokenProperties.class);
		}
