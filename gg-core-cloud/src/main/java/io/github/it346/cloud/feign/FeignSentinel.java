...
import feign.Target;
import io.github.it346.cloud.sentinel.SentinelInvocationHandler;
		...
		public Feign build() {
			super.invocationHandlerFactory(new InvocationHandlerFactory() {
				...
				public InvocationHandler create(Target target, Map<Method, MethodHandler> dispatch) {
					...
					// 默认fallbackFactory
					FallbackFactory factory = new FallbackFactory(target);
					return new SentinelInvocationHandler(target, dispatch, factory);
				}
